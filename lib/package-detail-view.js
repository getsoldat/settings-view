...
export default class PackageDetailView {
  ...
  activateConfig () {
    ...
    if (soldat.packages.isPackageLoaded(this.pack.name) && !soldat.packages.isPackageActive(this.pack.name)) {
        ...
        <section className='section'>
          <form className='section-container package-detail-view'>
            ...
            <div ref='buttons' className='btn-wrap-group hidden'>
              <button ref='learnMoreButton' className='btn btn-default icon icon-link'>View on Soldat.io</button>
  ...
  updateInstalledState () {
    ...
    const sourceIsAvailable = this.packageManager.isPackageInstalled(this.pack.name) && !soldat.packages.isBundledPackage(this.pack.name)
  ...
  updateFileButtons () {
    ...
    const packagePath = this.pack.path != null ? this.pack.path : soldat.packages.resolvePackagePath(this.pack.name)
