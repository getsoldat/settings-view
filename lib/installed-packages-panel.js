...
export default class InstalledPackagesPanel extends CollapsibleSectionPanel {
        ...
        <section className='section'>
          <div className='section-container'>
            ...
            <section ref='deprecatedSection' className='sub-section deprecated-packages'>
              ...
              <p>Soldat does not load deprecated packages. These packages may have updates available.</p>
  ...
  filterPackages (packages) {
    ...
    packages.deprecated = packages.user.filter(({name, version}) => soldat.packages.isDeprecatedPackage(name, version))
