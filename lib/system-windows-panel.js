...
import {WinShell, CompositeDisposable} from 'soldat'
        ...
        <form className='general-panel section'>
          <div className='settings-panel'>
            <div className='section-container'>
              ...
              <div className='text icon icon-question'>These settings determine how Soldat integrates with your operating system.</div>
