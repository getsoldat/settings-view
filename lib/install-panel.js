...
export default class InstallPanel {
  constructor (settingsView, packageManager) {
    ...
    this.soldatIoURL = 'https://soldat.tv/packages'
    ...
    this.disposables.add(soldat.commands.add(this.refs.searchEditor.element, 'core:confirm', () => {
      this.performSearch()
    }))
        ...
        <div className='section packages'>
          <div className='section-container'>
            ...
            <div className='text native-key-bindings' tabIndex='-1'>
              ...
              <a className='link' onclick={this.didClickOpenSoldatTv.bind(this)}>soldat.tv</a>
              <span> and are installed to {path.join(process.env.SOLDAT_HOME, 'packages')}</span>
            </div>
  ...
  setSearchType (searchType) {
    if (searchType === 'theme') {
      ...
      this.soldatIoURL = 'https://soldat.tv/themes'
  ...
  didClickOpenSoldatTv (event) {
    event.preventDefault()
    electron.shell.openExternal(this.soldatIoURL)
  }
