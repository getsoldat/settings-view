...
export default class PackageGrammarsView {
  constructor (packagePath) {
    ...
    this.addGrammars()
    this.disposables.add(soldat.grammars.onDidAddGrammar(() => this.addGrammars()))
    this.disposables.add(soldat.grammars.onDidUpdateGrammar(() => this.addGrammars()))
  }
  ...
  getPackageGrammars () {
    ...
    const grammars = soldat.grammars.grammars != null ? soldat.grammars.grammars : []
